...
//		String deptSelected = adapterDept.getItem(0).toString();
		...
		ListView mEpcListView = (ListView) this.findViewById(R.id.lstPartsSendOutView);
	...
	protected void onDestroy() {
		if (listPartsEntity.size() > 0) {
			...
			String takeUserStr = sprTakeUser.getSelectedItem().toString().split("-")[0];
			String takeDeptStr = sprTakeDept.getSelectedItem().toString().split("-")[0];
